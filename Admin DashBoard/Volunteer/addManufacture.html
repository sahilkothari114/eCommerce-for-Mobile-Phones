                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="card-header" data-background-color="purple">
                                    <h2 class="title"><center>Add Manufacturer</center></h2>
								...
								<div class="content">
									...
									<form action="addcertificate.html" method="get">					
										<input type="text" class="form-control" placeholder="Manufacturer Name" required/>										
										<input type="submit" name="txtadd" value="Add" class="btn btn-primary">
									</form>
									</div>
								</div>	
                ...
                <div class="container-fluid">
                    <div class="row">                        
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h3 class="title"><center>Manufacturers</center></h3>
                                    <!--<p class="category">Here is a subtitle for this table</p>-->
                                </div>
