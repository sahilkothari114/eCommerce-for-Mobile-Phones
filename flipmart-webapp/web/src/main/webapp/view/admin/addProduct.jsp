                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="purple">
                                        <h2 class="title"><center>Add Product</center></h2>
                                    ...
                                    <div class="card-content">
                                        <form action="#" method="POST">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <select class="form-control" name="drpManufaturer" style="float:left;" required>
                                                            <option value="101">Nokia</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="txtModelNumber" onblur="return allLetter(txtModelNumber);" class="form-control" required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Product Name</label>
                                                        <input type="text" name="txtProductName" onblur="return allLetter(txtProductName);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="txtOperatingSystem" onblur="return allLetter(txtOperatingSystem);" class="form-control" required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">RAM</label>
                                                        <input type="text" name="txtRAM" onblur="return allLetter(txtRAM);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="txtCamera" onblur="return allLetter(txtCamera);" class="form-control" required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Processor</label>
                                                        <input type="text" name="txtProcessor" onblur="return allLetter(txtProcessor);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="txtPicture" onblur="return allLetter(txtPicture);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="textarea" name="txtAdditionalFeatures" onblur="return allLetter(txtAdditionalFeatures);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" name="txtPrice" onblur="return allLetter(txtPrice);" class="form-control" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <center>
                                                <input type="submit" value="Add" class="btn btn-primary pull-right"></center>
